...
import com.example.xcs.xcsdemo.Util.DensityUtil;
...
public class EventDispatchPlanLayout extends ViewGroup {
    ...
    public EventDispatchPlanLayout(Context context, AttributeSet attrs) {
        ...
        mHeaderInitOffset = array.getDimensionPixelSize(R.styleable.EventDispatchPlanLayout_header_init_offset, DensityUtil.dp2px(getContext(), 20));
        mTargetInitOffset = array.getDimensionPixelSize(R.styleable.EventDispatchPlanLayout_target_init_offset, DensityUtil.dp2px(getContext(), 40));
        ...
        mTouchSlop = DensityUtil.px2dp(context, vc.getScaledTouchSlop());
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        int scrollMeasureWidthSpec = MeasureSpec.makeMeasureSpec(getMeasuredWidth() - getPaddingLeft() - getPaddingRight(),
                MeasureSpec.EXACTLY);
        int scrollMeasureHeightSpec = MeasureSpec.makeMeasureSpec(getMeasuredHeight() - getPaddingBottom() - getPaddingTop(),
                MeasureSpec.EXACTLY);
    ...
    protected void onLayout(boolean changed, int l, int t, int r, int b) {
        ...
        mHeaderView.layout(width / 2 - refreshViewWidth / 2, mHeaderCurrentOffset, width / 2 + refreshViewWidth / 2,
                mHeaderCurrentOffset + refreshViewHeight);
    }
